...
identified as RAM. ✅ means observed on a MKI or in the running emulator;
🟡 means a code or emulator finding still awaiting an isolated hardware test.
